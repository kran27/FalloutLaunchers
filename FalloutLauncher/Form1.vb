...
Public Class Form1
    ...
    Private Sub Form1_MouseDown(ByVal sender As Object, ByVal e As Windows.Forms.MouseEventArgs) Handles MyBase.MouseDown, PictureBox1.MouseDown
    ...
    Private Sub Form1_Load() Handles MyBase.Load
        Dim ini As String()
        Try : ini = IO.File.ReadAllLines(".\\fallout.cfg") : Catch : End Try
        If ini IsNot Nothing Then
            ...
            Select Case lang
                ...
                Case "italian"
                    PBI(0) = My.Resources.Play_IT : PBI(1) = My.Resources.Play_IT_Pressed
                    RBI(0) = My.Resources.ReadMe_IT : RBI(1) = My.Resources.ReadMe_IT_Pressed
                    TBI(0) = My.Resources.TS_IT : RBI(1) = My.Resources.TS_IT_Pressed
                    EBI(0) = My.Resources.Exit_IT : RBI(1) = My.Resources.ReadMe_IT_Pressed
                Case "german"
                ...
                Case "spanish"
                    PBI(0) = My.Resources.Play_ES : PBI(1) = My.Resources.Play_ES_Pressed
                    RBI(0) = My.Resources.ReadMe_ES : RBI(1) = My.Resources.ReadMe_ES_Pressed
                    TBI(0) = My.Resources.TS_ES : RBI(1) = My.Resources.TS_ES_Pressed
                    EBI(0) = My.Resources.Exit_ES : RBI(1) = My.Resources.ReadMe_ES_Pressed
            End Select
        End If
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        If args.Contains("-classic") Then
            Process.Start("falloutw.exe")
        Else
            Process.Start("falloutwhr.exe")
        End If
        Application.Exit()
    End Sub
